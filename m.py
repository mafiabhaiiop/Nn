...
# Bot configuration
BOT_TOKEN = "8320742415:AAFi3S2cygkQnhA1zHgiYieDHeClhMShUZ0"
...
Contact admin for support: @MAFIAOP08
"""
        )
        return
...
└─ /attack 9876543210 300 - 5 minutes
...
"""
    ...
    try:
        ...
        if duration < 10:
            ...
            return
        if duration > 300:
            await update.message.reply_text("❌ Duration cannot exceed 300 seconds (5 minutes).")
            return
    except ValueError:
